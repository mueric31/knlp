...
MEMORY_LIMIT = 5  # how many previous turns to keep
...
def main():
    ...
    ap.add_argument("--max_new_tokens", type=int, default=150)  # longer outputs
    ...
    while True:
        ...
        memory_text = "\n".join(conversation_memory[-MEMORY_LIMIT:])
        prompt = f"{memory_text}\nQ: {q}\nCONTEXT:\n{ctx}\nA:" if memory_text else f"Q: {q}\nCONTEXT:\n{ctx}\nA:"
        ...
        # Update memory
        conversation_memory.append(f"Q: {q}\nA: {ans}")
